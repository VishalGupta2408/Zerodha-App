...
const Holdings = () => {
  ...
  // Calculate totals dynamically from holdings data
      ...
      <div className="row">
        ...
        <div className="col">
          <h5 className={pnlClass}>
            {totalPnl.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} ({totalPnlPercent >= 0 ? "+" : ""}{totalPnlPercent.toFixed(2)}%)
          </h5>
          <p>P&L</p>
        </div>
      </div>
